...
#define MAX_APPLICATION_SPEED_RPM           3816 /*!< rpm, mechanical */
...
#define PID_TORQUE_KI_DEFAULT               2933
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2071
#define PID_FLUX_KI_DEFAULT                 2933
...
#define PID_SPEED_KP_DEFAULT                2056/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                476/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            1373
...
#define FINAL_I_ALIGNMENT_A                 7.25 /*!< s16A */
