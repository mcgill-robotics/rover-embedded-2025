...
#define MAX_APPLICATION_SPEED_RPM           2514 /*!< rpm, mechanical */
...
#define PID_TORQUE_KI_DEFAULT               2695
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2367
#define PID_FLUX_KI_DEFAULT                 2695
...
#define PID_SPEED_KP_DEFAULT                3863/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                2263/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define FINAL_I_ALIGNMENT_A                 12 /*!< s16A */
