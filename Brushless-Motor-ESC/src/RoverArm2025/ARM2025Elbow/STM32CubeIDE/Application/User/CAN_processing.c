...
#define WAIST_GEAR_RATIO 21 //THIS NUMBER IS NOT RIGHT LOL
...
//				}
		...
		case(READ_POSITION):
				...
				float positionAdjusted = inputShaftDegreetoOutput(CANMessageID, positionDegrees);
...
//	if(switch1_opened){
//
//		MC_ProgramSpeedRampMotor1_F(CALIBRATION_OFFSET_SPEED, 0);
//		if (!MC_StartMotor1()) {
//				////////////////////////////////////////////////////////////////////////////////////////////////////////
//				 uart_debug_print("Start Failed...");
//				////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//	else{
//		MC_ProgramSpeedRampMotor1_F(CALIBRATION_SPEED, 0);
//		if (!MC_StartMotor1()) {
//				////////////////////////////////////////////////////////////////////////////////////////////////////////
//				 uart_debug_print("Start Failed...");
//				////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void ControlSingleMotorPosition(ParsedCANID *CANMessageID, float newPosition){
	...
	case(RUN):
		...
		uart_debug_print("Motor State: Run\r\n");
		////////////////////////////////////////////////////////////////////////////////////////////////////////
		runSingleMotorPosition(CANMessageID, newPosition);
		break;
...
void runSingleMotorPosition(ParsedCANID* CANMessageID, float rawPosDegrees){

//	if (!isValidPos(CANMessageID, rawPosDegrees)){
//		////////////////////////////////////////////////////////////////////////////////////////////////////////
//		uart_debug_print("Position setpoint is not valid\r\n");
//		////////////////////////////////////////////////////////////////////////////////////////////////////////
//		return;
//	}
	float inputShaftDegreeSetpoint = OutputShaftDegreetoInput(CANMessageID, rawPosDegrees);
