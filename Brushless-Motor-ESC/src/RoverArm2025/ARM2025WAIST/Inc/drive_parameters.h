...
#define MAX_APPLICATION_SPEED_RPM           3210 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               2367
#define PID_TORQUE_KI_DEFAULT               2959
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2367
#define PID_FLUX_KI_DEFAULT                 2959
...
#define PID_SPEED_KP_DEFAULT                2870/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                117/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define IQMAX_A                             9.279

/* Default settings */
#define DEFAULT_CONTROL_MODE                MCM_SPEED_MODE
#define DEFAULT_TARGET_SPEED_RPM            1156
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

#define PID_POSITION_KP_GAIN				25
#define PID_POSITION_KI_GAIN                0 //1000 base
#define PID_POSITION_KD_GAIN                0 //1000 base
...
#define FINAL_I_ALIGNMENT_A                 9.279 /*!< s16A */
