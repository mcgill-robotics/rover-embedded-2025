...
int ESC_ID = SHOULDER_CAN_ID; // CHANGE THIS ID FOR EACH ESC THAT IS CONNECTED TO THE ARM SYSTEM!
volatile bool received_CAN_command = false;
volatile bool switch1_opened = false; // Opened here means the switch is pressed, thus opening the connection
volatile bool switch2_opened = false;
