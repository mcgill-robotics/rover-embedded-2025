...
// Motor CANIDs
//#define DEBUG_PRINT
#define WAIST_CAN_ID 0
#define SHOULDER_CAN_ID 1
#define ELBOW_CAN_ID 2
...
int ESC_ID = WAIST_CAN_ID; // CHANGE THIS ID FOR EACH ESC THAT IS CONNECTED TO THE ARM SYSTEM!
